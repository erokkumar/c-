...
#Module for creating the database and the table
def Database():
...
# LABELS
    lbl_title = Label(FormTitle, text="Updating Contacts", font=('arial', 16), bg="blue", width=300)
...
#Delete query for deleting the value in the database
def Delete():
...
#module is for the frame, labels, text entry, and button for add new contact form window
def AddNewContact():
    global NewWindow
    f_name.set("")
    m_name.set("")
...
#Module for creating a tables in contact management system window
...
tree.pack()
tree.bind('<Double-Button-1>', UpdateContactWin